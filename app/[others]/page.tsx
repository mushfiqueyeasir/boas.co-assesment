...
export const metadata = generateMetadata(SeoContent["errorSeo"] || SeoContent.baseSeo);
const NotFound = () => {
    return (
        <>
            <section className="relative z-10 flex h-[91vh] items-center justify-center ">
                                ...
                                <div className="mx-auto mb-9 text-center">
                                    ...
                                    >
                                        ...
                                        <path
                                            ...
                                            strokeWidth="3"
                                        />
                                        <circle opacity="0.8" cx="227.5" cy="81.5" r="68.5" fill="#01AB5B" />
                                        <mask
                                            id="mask0_116:1137"
                                        ...
                                        <defs>
                                            ...
                                            >
                                                <stop stopColor="#01AB5B" stopOpacity="0" />
                                                <stop offset="1" stopColor="#01AB5B" />
                                            </linearGradient>
                                            <linearGradient
                    ...
                    <svg width="406" height="286" viewBox="0 0 406 286" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            ...
                            <linearGradient
                                ...
                                gradientUnits="userSpaceOnUse"
                            >
                                <stop stopColor="#01AB5B" />
                                <stop offset="1" stopColor="#01AB5B" stopOpacity="0" />
                            </linearGradient>
                            <linearGradient
